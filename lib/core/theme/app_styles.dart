...
extension ShipXBadgeVariantX on ShipXBadgeVariant {
  Color get background => switch (this) {
    ShipXBadgeVariant.primary => AppColors.primary,
    ShipXBadgeVariant.success => const Color(0xFFDCFCE7),
    ShipXBadgeVariant.error => const Color(0xFFFFEDED),
    ShipXBadgeVariant.neutral => AppColors.bg2,
  };

  Color get foreground => switch (this) {
    ShipXBadgeVariant.primary => AppColors.primary,
    ShipXBadgeVariant.success => const Color(0xFF15803D),
    ShipXBadgeVariant.error => AppColors.red,
    ShipXBadgeVariant.neutral => AppColors.body,
  };
}
...
extension ShipXButtonSizeX on ShipXButtonSize {
  ...
  TextStyle get textStyle => switch (this) {
    ShipXButtonSize.sm => AppTextStyles.body6,
    ShipXButtonSize.md => AppTextStyles.body5,
    ShipXButtonSize.lg => AppTextStyles.body1,
  };
