...
class AppColorScheme extends ThemeExtension<AppColorScheme> {
  ...
  static const AppColorScheme light = AppColorScheme(
    ...
    secondary: AppColors.titleLight,
    background: AppColors.backgroundLight,
    surface: AppColors.bg1Light,
    surfaceVariant: AppColors.bg2Light,
    elevatedSurface: AppColors.white,
    appBar: AppColors.white,
    border: AppColors.borderLight,
    outline: AppColors.borderLight,
    divider: AppColors.borderLight,
    textPrimary: AppColors.titleLight,
    textSecondary: AppColors.bodyLight,
  ...
  static const AppColorScheme dark = AppColorScheme(
    primary: AppColors.primary,
    secondary: AppColors.titleDark,
    background: AppColors.backgroundDark,
    surface: AppColors.bg1Dark,
    surfaceVariant: AppColors.bg2Dark,
    elevatedSurface: Color(0xFF1E293B),
    appBar: Color(0xFF0F172A),
    border: AppColors.borderDark,
    outline: AppColors.borderDark,
    divider: AppColors.borderDark,
    textPrimary: AppColors.titleDark,
    textSecondary: AppColors.bodyDark,
